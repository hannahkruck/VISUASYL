...
def write():
    ...
    with st.spinner("Loading Map ..."):
        ...
        df = pd.read_csv("https://raw.githubusercontent.com/hannahkruck/VIS_Test1/Develop/map10-37.csv", encoding ="utf8", sep=";")
        # CSV for Line Map
        df2 = pd.read_csv("https://raw.githubusercontent.com/hannahkruck/VIS_Test1/Develop/map10-37.csv", encoding ="utf8", sep=";")
