...
def write():
    ...
    with st.spinner("Loading Map ..."):
        ...
        df = pd.read_csv("https://raw.githubusercontent.com/hannahkruck/visuasyl/master/Map.csv", encoding ="utf8", sep=";")
        # CSV for Line Map
        df2 = pd.read_csv("https://raw.githubusercontent.com/hannahkruck/visuasyl/master/Map.csv", encoding ="utf8", sep=";")
